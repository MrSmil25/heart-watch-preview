...
export const personas: Persona[] = [
  ...
  },
  {
    ...
    unlockText:
      "Nay, 20 kartu dan aku udah bisa lihat: kamu jarang keliatan panik ngerespons, tapi bacaan kamu tajem. Kamu tipe yang mikir sebelum bereaksi, dan itu bikin kamu jarang nyakitin orang tanpa sengaja. Yang belum keliatan: seberapa hangat kamu pas jawab. Kita liat 20 kartu lagi.",
    fullText:
      "Nay, kamu Detektif Tenang. Dari 40 momen, kamu bisa nangkep maksud tersembunyi jauh lebih sering dari kebanyakan orang. Yang perlu dilatih: kadang bacaan tepat aja belum cukup — cara nyampeinnya perlu se-lembut isinya. Kamu jarang salah, jadi pas kamu salah, orang nggak siap. Latihannya bukan lebih tajem, tapi lebih pelan.",
  },
  {
    id: "percaya-polos",
    name: "PERCAYA POLOS",
